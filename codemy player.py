...
def add_song():
	...
	song = song.replace("E:/Songs/K-POP/", "")
...
back_btn_img = PhotoImage(file='play.png')
forward_btn_img =  PhotoImage(file='play.png')
play_btn_img =  PhotoImage(file='play.png')
pause_btn_img =  PhotoImage(file='play.png')
stop_btn_img =  PhotoImage(file='play.png')
...
global vol3
global vol4
vol0 = PhotoImage(file='play.png')
vol1 = PhotoImage(file='play.png')
vol2 = PhotoImage(file='play.png')
vol3 = PhotoImage(file='play.png')
vol4 = PhotoImage(file='play.png')
