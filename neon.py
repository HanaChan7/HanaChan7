...
class MusicPlayer:
  ...
  def __init__(self,root):
    ...
    songsframe = LabelFrame(self.root,text="Song Playlist",font=("Fixedsys",18,"bold"),bg="#d3168c",fg="black",bd=5,relief=FLAT)
    ...
    # Create Status Bar
    self.status_bar = Label(root,font=("Fixedsys",4),text='',bd=1,relief=FLAT,anchor=E,bg="#1210d9",fg="black")
    ...
    selectbtn = Button(self.status_bar,text="SELECT",command=self.selectfolder,width=5,height=1,font=("Fixedsys",4,"bold"),
                    fg="black",bg="#1210d9",relief=FLAT, activebackground="#1210d9").grid(row=0,column=1,padx=2,pady=2)
